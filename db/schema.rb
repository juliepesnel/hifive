...
ActiveRecord::Schema.define(version: 20170307113844) do
  ...
  create_table "tastes", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["category_id"], name: "index_tastes_on_category_id", using: :btree
    t.index ["user_id"], name: "index_tastes_on_user_id", using: :btree
  end
  ...
  add_foreign_key "tastes", "categories"
